...
import { ArrowRight, Award, Search, Sparkles, TrendingUp, Users } from "lucide-react";
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative pt-16 pb-24 md:pt-24 md:pb-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1
              className="font-display font-bold text-4xl md:text-6xl lg:text-7xl leading-tight mb-6 opacity-0 animate-fade-in"
              style={{ animationDelay: "100ms" }}
            >
              Discover Courses That <span className="text-gradient">Shape Your Future</span>
            </h1>
            <p
              className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto opacity-0 animate-fade-in"
            ...
            <form
              onSubmit={onSearch}
              className="relative max-w-2xl mx-auto mb-8 opacity-0 animate-fade-in"
          ...
          <div className="hidden lg:flex absolute top-32 -left-12 flex-col items-center animate-float opacity-90">
            <div className="glass-card px-6 py-4 rotate-[-6deg] bg-secondary/10 border-secondary/20 shadow-[0_0_30px_hsl(var(--secondary)/0.15)] text-secondary transition-transform duration-500 hover:scale-110">
              ...
              <p className="font-display font-bold text-lg leading-tight tracking-wide">
                Unlock Your
                <br />
                Potential
              </p>
          ...
          <div
            className="hidden lg:flex absolute top-20 right-24 flex-col items-center animate-float opacity-70"
